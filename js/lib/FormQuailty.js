...
var target = new Vue({
    ...
    methods: {
        ...
        download: function download() {
            ...
            axios.post(webApiUrl + '/api/FormQuailty/Download?random=' + Math.random(), _.searchModel).then(function (response) {
        ...
        changePage: function changePage(pageIndex) {
            ...
            axios.post(webApiUrl + '/api/FormQuailty/GetPageList?random=' + Math.random(), _.searchModel).then(function (response) {
                if (response.data.status) {
