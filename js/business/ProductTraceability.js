...
{ key: 'productNo', title: '成品号', align: 'center' },
{ key: 'productName', title: '成品名称', align: 'center' },
{ key: 'subPartsNo', title: '子件号', align: 'center' },
{ key: 'subPartsName', title: '子件名称', align: 'center' },
{ key: 'batchNo', title: '炉号', align: 'center' },
{ key: 'batchId', title: '流水号', align: 'center' },
{
    key: 'warehousing',
    title: '入库时间',
    align: 'center',
...
var searchDemo_productionInfoListColumns = [
    { field: 'processName', title: '工序名称', columnAlign: 'center', titleAlign: 'center', width: 100, isResize: true },
    { field: 'orderNo', title: '工单号', columnAlign: 'center', titleAlign: 'center', width: 100, isResize: true },
    { field: 'equipmentName', title: '生产设备', columnAlign: 'center', titleAlign: 'center', width: 100, isResize: true },
    { field: 'operatorUserName', title: '操作员', columnAlign: 'center', titleAlign: 'center', width: 100, isResize: true },
    {
        field: 'submitTime',
        title: '提交时间',
        columnAlign: 'center',
    ...
    searchDemo_checkInfoListColumns = [
        { width: 130, columnAlign: 'center', field: 'processName', isResize: true }, //工序名称
        {
            width: 100,
            columnAlign: 'center',
            field: 'batchNo',
        ...
        { width: 50, columnAlign: 'center', field: 'processResult', isResize: true } //工序结果
    ],
    searchDemo_checkInfoListTitleColumns = [
        [
            { fields: ['processName'], title: '工序名称', titleAlign: 'center', rowspan: 3 },
            { fields: ['batchNo'], title: '关联信息', titleAlign: 'center', rowspan: 3 },
            { fields: ['orderNo'], title: '工单号', titleAlign: 'center', rowspan: 3 },
            { fields: ['qualityName'], title: '工序检验项', titleAlign: 'center', rowspan: 3 },
            { fields: ['evaluation'], title: '评价测量技术', titleAlign: 'center', rowspan: 3 },
            { fields: ['frequency'], title: '检测频率', titleAlign: 'center', rowspan: 3 },
            { fields: ['myCheck', 'professionalCheck', 'operatorUserName', 'checkUserName', 'processResult'], title: '工序检验项', titleAlign: 'center', colspan: 5 },
        ],
        [
            { fields: ['myCheck', 'professionalCheck', 'operatorUserName', 'checkUserName'], title: '实测数据', titleAlign: 'center', colspan: 4 },
            { fields: ['processResult'], title: '判定', titleAlign: 'center', rowspan: 2 },
        ],
        [
            { fields: ['myCheck'], title: '自检', titleAlign: 'center' },
            { fields: ['professionalCheck'], title: '专检', titleAlign: 'center' },
            { fields: ['operatorUserName'], title: '操作员', titleAlign: 'center' },
            { fields: ['checkUserName'], title: '检验员', titleAlign: 'center' }
        ]
    ],
    aboutInfoColumns = [
        { width: 130, columnAlign: 'center', field: 'batchNo', title: '检测炉号', titleAlign: 'center', isResize: true },
        { width: 120, columnAlign: 'center', field: 'aboutNo', title: '关联炉号', titleAlign: 'center', isResize: true },
    ];
var isServer = true;
var url = isServer ? {
    ...
    methods: {
        selectedChange: function (selection) {
            ...
            selection.forEach((item) => {
                this.selectedArray.push(item.batchNo);
            })
        ...
        search: function (isAllCheck, callback) {
            var _ = this;
            //获取搜索的参数
        ...
        tableExpand: function (row, state, a) {
            var _ = this;
        ...
        showAbout: function (ThroughputId, batchNo) {
        ...
        ajax: function (url, params, callback, method, sync, type) {
        ...
        batchNocellMerge(rowIndex, rowData, field) {
            if (field === 'batchNo') {
                return {
                    colSpan: 1,
...
Vue.component('checkInfoComponent', {
    ...
    methods: {
        checkInfoCellMerge: function (rowIndex, rowData, field) {
...
function checkFormatter(rowData, rowIndex, pagingIndex, field) {
    ...
    if (field == 'myCheck') {
        if (rowData.myCheck == 1) {
            ...
            return (rowData.myCheckValue == "" || rowData.myCheckValue == undefined) ? "-" : rowData.myCheckValue;
        }
        ...
        if (rowData.professionalCheck == 1) {
            ...
            return (rowData.professionalCheckValue == "" || rowData.professionalCheckValue == undefined) ? "-" : rowData.professionalCheckValue;
        }
    }
}
