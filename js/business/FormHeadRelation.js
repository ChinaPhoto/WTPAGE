    var target = new Vue({
        ...
        methods: {
            ...
            download() {
                ...
                axios.post(webApiUrl + '/api/FormHeadRelation/Download?random=' + Math.random(), _.searchModel)
            ...
            changePage(pageIndex) {
                ...
                axios.post(webApiUrl + '/api/FormHeadRelation/GetPageList?random=' + Math.random(), _.searchModel)
                    .then(function(response) {
                        if (response.data.status) {
