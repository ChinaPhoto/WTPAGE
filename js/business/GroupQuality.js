    var target = new Vue({
        ...
        methods: {
            ...
            download() {
                ...
                axios.post(webApiUrl + '/api/GroupQuality/Download?random=' + Math.random(), _.searchModel)
            ...
            changePage(pageIndex) {
                ...
                axios.post(webApiUrl + '/api/GroupQuality/GetPageList?random=' + Math.random(), _.searchModel)
                    .then(function(response) {
                        if (response.data.status) {
